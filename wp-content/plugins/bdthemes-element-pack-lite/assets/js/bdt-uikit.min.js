...
(function(we, xe) {
    typeof exports == "object" && typeof module < "u" ? module.exports = xe() : typeof define == "function" && define.amd ? define("uikit", xe) : (we = typeof globalThis < "u" ? globalThis : we || self, we.bdtUIkit = xe())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: we,
    ...
    function Tr() {
        return Ne || (ce || (ce = y("<div>"), h(ce, {
            height: "100vh",
            position: "fixed"
        }), $(window, "resize", () => Ne = null)), q(document.body, ce), Ne = ce.clientHeight, ot(ce), Ne)
    }
    const At = {
            read: Cr,
            write: Pr,
        ...
        function s(r, a, l, c) {
            return new Promise(u => {
                ...
                (function ve() {
                    ...
                    let bt = 0;
                    i[0] === r && f + a < c && (bt = E(l).top + (w ? 0 : r.scrollTop) - I - m(us(l)).height), r.scrollTop = f + (a + bt) * be, be === 1 && (P === bt || !vt--) ? u() : (P = bt, requestAnimationFrame(ve))
                })()
            })
        }
    ...
    function rt(t) {
        ...
        for (let [l, c, u, f] of [
            ...
            const d = n[l] % 1;
            n[u] += k(h(a, `border-${u}-width`)), n[l] = n[c] = a[`client${kt(l)}`] - (d ? d < .5 ? -d : 1 - d : 0), n[f] = n[l] + n[u]
        }
        return n
    }
    ...
    function us(t) {
        ...
        for (const n of s ? [0, s] : [0]) {
            let o;
            for (const r of Mt(t).document.elementsFromPoint(e + i / 2, n)) !r.contains(t) && !x(r, "bdt-togglable-leave") && (fs(r, "fixed") && gn(_e(t).reverse().find(a => !a.contains(r) && !fs(a, "static"))) < gn(r) || fs(r, "sticky") && D(r).contains(t)) && (!o || m(o).height < m(r).height) && (o = r);
            if (o) return o
        }
    }
    ...
    function Si(t = {}) {
        return ue({
            handler: function(e, i) {
                ...
                for (const o of T(tt(s) ? s(this) : s)) N('[loading="lazy"]', o).slice(0, n - 1).forEach(r => Ee(r, "loading"));
        ...
        qt = {
            ...
            methods: {
                ...
                _toggle(t, e) {
                    ...
                    e = !!e;
                    let i;
                    this.cls ? (i = v(this.cls, " ") || e !== x(t, this.cls), i && j(t, this.cls, v(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden, i && (t.hidden = !e)), N("[autofocus]", t).some(s => R(s) ? s.focus() || !0 : s.blur()), i && b(t, "toggled", [e, this])
                }
            }
        };
    ...
    var Ss = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                !i && s && re(e) && !this.$el.contains(y(s)) ? this.hide() : C(e, this.selClose) && (t.preventDefault(), this.hide())
            }
        }, {
            name: "toggle",
            self: !0,
    ...
    var xa = {
        ...
        methods: {
            start() {
                this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, $(document, Es, this.move, qe), $(document, Hn, this.end, Fn), h(this.list, "userSelect", "none")
            },
            move(t) {
                const e = this.pos - this.drag;
                if (e === 0 || this.prevPos === this.pos || !this.dragging && Math.abs(e) < this.threshold) return;
                this.dragging || $(this.list, "click", Ln, qe), t.cancelable && t.preventDefault(), this.dragging = !0, this.dir = e < 0 ? 1 : -1;
                let {
                    slides: i,
                    prevIndex: s
                ...
                setTimeout(() => Tt(this.list, "click", Ln, qe)), h(this.list, {
                    userSelect: ""
    ...
    function ka(t, e) {
        for (const {
                ...
                handler: s,
                immediate: n = !0
            } of t._watches)(t._initial && n || pt(e, i) && !Ie(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    ...
    function Vn(t, e, i) {
        ...
        n = tt(n) ? n.call(t, t) : n || t.$el, !(!n || G(n) && !n.length || c && !c.call(t, t)) && t._events.push($(n, s, l ? z(l) ? l : l.call(t, t) : null, z(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u
        }))
    ...
    function Aa(t, e) {
        ...
        tt(s) && !pt(t, l) && qn(t, l, () => {
            const f = s.call(t, t);
            return G(f) ? T(f) : f
        }), n = z(n) ? t[n] : n.bind(t), tt(o) && (o = o.call(t, t));
    ...
    function Ts(t) {
        t._connected || (Da(t), de(t, "beforeConnect"), t._connected = !0, Ta(t), Gr(t), ya(t), Pa(t), Ba(t), Ia(t), de(t, "connected"), He(t))
    }
    ...
    function Xn(t, e = {}) {
        e.data = Ha(e, t.constructor.options), t.$options = Fe(t.constructor.options, e, t), t.$props = {}, t._uid = Na++, za(t), Fa(t), Sa(t), de(t, "created"), e.el && t.$mount(e.el)
    }
    ...
    function Jn(t, e) {
        ...
        return o.id = n, o.name = t, (s = o.install) == null || s.call(o, lt, o, t), lt._initialized && !o.functional && requestAnimationFrame(() => Ue(t, `[${n}],[data-${n}]`)), pe[n] = o
    }
    ...
    function Ra(t) {
        t.component = Jn, t.getComponents = Ve, t.getComponent = Ti, t.update = Kn, t.use = function(i) {
    ...
    function _i(t, e, i) {
        ...
        }), i.length === 1 && i.unshift(t === "scale" ? 1 : 0), i = ge(i, n), (o, r) => {
            o.transform = `${o.transform||""} ${t}(${Ge(i,r)}${s})`
        }
    }

    function Ps(t, e, i) {
        return i.length === 1 && i.unshift(Xe(e, t, "")), i = ge(i, s => el(e, s)), (s, n) => {
    ...
    function il(t, e, i) {
        return i.length === 1 && i.unshift(Xe(e, t, "")), i = ge(i), (s, n) => {
            s[t] = Ge(i, n)
        }
    }
    ...
    function sl(t, e, i) {
        ...
        const s = Oi(i),
            n = oo(e);
        return i = ge(i.reverse(), o => (o = k(o), s === "%" ? o * n / 100 : o)), i.some(([o]) => o) ? (h(e, "strokeDasharray", n), (o, r) => {
        ...
        methods: {
            ...
            updateActiveClasses(t = this.index) {
                ...
                for (const s of this.slides) {
                    ...
                    for (const o of N(Ce, s)) pt(o, "_tabindex") || (o._tabindex = g(o, "tabindex")), g(o, "tabindex", n ? o._tabindex : -1)
                }
            },
            getValidIndex(t = this.index, e = this.prevIndex) {
    ...
    var pl = { ...Is,
        ...
        ml = {
            ...
            methods: {
                ...
                insert(t, e) {
                    S(this.items, this.clsItem), e && e.previousElementSibling !== t ? this.animate(() => hi(e, t)) : !e && this.target.lastElementChild !== t && this.animate(() => q(this.target, t))
                },
                remove(t) {
    ...
    async function zl(t, e, {
        ...
        s = (n * c + s) * (e ? 1 - u : u), h(a, "height", l), await B.start(a, {
            height: e ? c : 0
        }, s, o), Me(i), delete t._wrapper, e || Bi(i, !0)
    }
    ...
    var Mo = {
        ...
        beforeConnect() {
            this.autoplay === "inview" && !It(this.$el, "preload") && (this.$el.preload = "none"), H(this.$el, "iframe") && !It(this.$el, "allow") && (this.$el.allow = "autoplay"), this.autoplay === "hover" && (H(this.$el, "video") ? this.$el.tabindex = 0 : this.autoplay = !0), this.automute && cn(this.$el)
        },
        events: [{
            name: `${Ht} focusin`,
            filter: ({
    ...
    var Fo = {
        ...
        events: [{
            ...
            handler(t) {
                ...
                s === O.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(), (e = y(Ce, n.$el)) == null || e.focus()), Ho(t, this.items, n)
            }
        }, {
            name: "keydown",
            el: ({
    ...
    var Ec = {
        ...
        methods: {
            async getSvg() {
                return H(this.$el, "img") && !this.$el.complete && this.$el.loading === "lazy" && await new Promise(t => F(this.$el, "load", t)), Cc(await Tc(this.src), this.icon) || Promise.reject("SVG not found.")
            }
        }
    };
    ...
    function Jc(t) {
        ...
        for (const l of [.25, .5, .75]) {
            ...
            for (const u of c) {
                if (t.contains(u) || !Kc(u) || u.closest('[class*="-leave"]') && c.some(d => u !== d && C(d, '[class*="-enter"]'))) continue;
    ...
    function th({
        ...
        t.dialog = function(i, s) {
            ...
            return e(({
                i18n: n
            }) => `<div class="bdt-modal-body">${z(i)?i:Pt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="bdt-modal-body">${z(i)?i:Pt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
        }, t.prompt = function(i, s, n) {
            const o = e(({
                    i18n: l
                }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${z(i)?i:Pt(i)}</label> <input class="bdt-input" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${l.cancel}</button> <button class="bdt-button bdt-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value),
                {
                    $el: r
                } = o.dialog,
                a = y("input", r);
    ...
    var ih = {
        ...
        events: [{
            ...
            async handler() {
                await sh(), !this.getActive() && this._transparent && (S(this.navbarContainer, Bs), this._transparent = null)
            }
        }],
        methods: {
    ...
    var nh = {
        ...
        events: [{
            ...
            handler() {
                ...
                S(t, this.clsContainer, this.clsFlip), h(t, "touch-action", "pan-y pinch-zoom"), h(this.$el, "display", "block"), h(this.panel, "maxWidth", e.clientWidth), S(this.$el, this.clsOverlay), S(this.panel, this.clsSidebarAnimation, this.mode === "reveal" ? "" : this.clsMode), et(t), S(t, this.clsContainerAnimation), this.clsContainerAnimation && oh()
            }
        }, {
            name: "hide",
            self: !0,
            ...
            self: !0,
            handler() {
                this.clsContainerAnimation && rh(), this.mode === "reveal" && Me(this.panel), _(this.panel, this.clsSidebarAnimation, this.clsMode), _(this.$el, this.clsOverlay), h(this.$el, "display", ""), h(this.panel, "maxWidth", ""), _(document.body, this.clsContainer, this.clsFlip)
            }
        }, {
    ...
    function Jo(t) {
        if (!t.defaultPrevented)
            for (const e of Ke) e.$el.contains(t.target) && re(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Yi(e.$el)))
    }
    ...
    var vh = {
            ...
            events: [{
                ...
                handler(t) {
                    this._preventClick = null, !(!dt(t) || ee(this._showState) || this.$el.disabled) && (b(this.$el, "focus"), F(document, ht, () => b(this.$el, "blur"), !0, e => !this.$el.contains(e.target)), v(this.mode, "click") && (this._preventClick = !0))
                }
            }, {
