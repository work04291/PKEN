    ...
    [995, 26, 534, 369, 804, 888, 680, 121, 288, 42, 50, 985, 287, 824, 58, 114, 443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 800, 149, 153, 495, 157], {
        ...
        9318: (e, t, n) => {
            ...
            class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
                ...
                deactivateActiveTab(e) {
                    super.deactivateActiveTab(e), this.removeAnimationFromContentIfNeeded()
                }
                ...
                isMobileDevice() {
                    if (void 0 !== elementorFrontend.utils.environment.isTouchDevice) return elementorFrontend.utils.environment.isTouchDevice;
                ...
                onInit() {
                    this.menuHeightController = new elementorProFrontend.utils.DropdownMenuHeightController(this.dropdownMenuHeightControllerConfig()), super.onInit(...arguments)
                }
        ...
        9638: (e, t, n) => {
            ...
            class StretchedMenuItemContent extends elementorModules.frontend.handlers.StretchedElement {
                ...
                stretch() {
                    this.isStretchSettingEnabled() && (!this.$element.hasClass("e-fit_to_content") || (0, s.isMenuInDropdownMode)(this.getElementSettings()) ? this.stretchElement.stretch() : this.stretchElement.reset())
                }
            }
            ...
            var n = elementorModules.frontend.handlers.Base.extend({
                ...
                bindEvents() {
                    ...
                    const toggleFullScreenSearch = () => {
                        t.toggleClass(l.isFullScreen).toggleClass(l.lightbox), s.trigger("focus")
                    };
                    "full_screen" === a ? (r.on("click", (function() {
            ...
            class ImageCarousel extends elementorModules.frontend.handlers.SwiperBase {
                ...
                getSwiperSettings() {
                    ...
                    Object.keys(s).reverse().forEach((t => {
                        ...
                        }, e.image_spacing_custom && (o.breakpoints[s[t].value].spaceBetween = this.getSpaceBetween(t)), r = +e["slides_to_show_" + t] || n
                ...
                updateSpaceBetween(e) {
                    const t = e.match("image_spacing_custom_(.*)"),
                        n = t ? t[1] : "desktop",
                        s = this.getSpaceBetween(n);
                    "desktop" !== n && (this.swiper.params.breakpoints[elementorFrontend.config.responsive.activeBreakpoints[n].value].spaceBetween = s), this.swiper.params.spaceBetween = s, this.swiper.update()
                }
            }
